  ...
  (
    ...
    React.useEffect(() => {
        const resetTimer = () => {
            ...
            if (open && !isMobile) { // Only run timer when sidebar is open on desktop
  ...
  return (
    <main
      ...
      className={cn(
        ...
        // Inset & Floating variants styling
        "md:peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-lg",
        className
      )}
      {...props}
    />
